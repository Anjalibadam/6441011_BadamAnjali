...
-- 2. Top Rated Events 
SELECT e.title, AVG(f.rating) AS average_rating, COUNT(f.feedback_id) AS total_feedback
FROM Events e
...
-- 5. Most Active Cities (top 5 by unique registrations)
